...
const AboutUs = () => {
    return (
        <>
            <Helmet>
                <title>Chúng tôi là ai? - Thang máy Việt Phát</title>
                <meta name="description" content="Tìm hiểu về Thang máy Việt Phát - đơn vị cung cấp giải pháp thang máy uy tín, chất lượng cao tại Việt Nam. Đội ngũ giàu kinh nghiệm, dịch vụ chuyên nghiệp." />
                <meta name="keywords" content="giới thiệu công ty thang máy, thang máy Việt Phát, công ty thang máy uy tín, thang máy chất lượng, đội ngũ kỹ thuật thang máy" />
